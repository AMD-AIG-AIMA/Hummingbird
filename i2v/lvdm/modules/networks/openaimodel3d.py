...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, context=None, features_adapter=None, fs=None, timestep_cond=None, motion_cond=None, **kwargs):
        b,_,t,_,_ = x.shape
        ...
        #print('AAAAAAAAAAAAAA', combined_cond_emb)
        #emb = self.time_embed(t_emb + timestep_cond_embed)
        ...
        if self.fs_condition:
            if fs is None:
                ...
                fs = torch.tensor(
                    [fs] * b, dtype=torch.long, device=x.device)

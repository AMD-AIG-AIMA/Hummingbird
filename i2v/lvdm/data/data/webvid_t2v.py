...
class WebVid(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #frames = frames.permute(3, 0, 1, 2).float() # [t,h,w,c] -> [c,t,h,w] frames will be tensor in accelerate launch
        # frames = frames.float()
...
if __name__== "__main__":
    ...
    config = OmegaConf.load('/group/ossdphi_algo_scratch_08/jieguo12/projects/t2v-turbo/configs/inference_t2v_512_v2.0_distil.yaml')
    config.data.params.train.params.video_length = 26
    config.data.params.num_workers = 0
    config.data.params.train.params.meta_path = '/group/ossdphi_algo_scratch_08/jieguo12/datasets/webvid/webvid-train-partial.csv'
    ...
    # for i, batch in tqdm(e
    # numerate(dataloader), desc="Data Batch"):
    #     video = batch['video']

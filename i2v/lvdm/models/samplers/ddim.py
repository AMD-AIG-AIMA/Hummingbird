...
class DDIMSampler(object):
    ...
    def sample(self,
        ...
        samples, intermediates, x_all, e_t_cond_all, e_t_uncond_all, t = self.ddim_sampling(conditioning, size,
                                                    callback=callback,
                                                    ...
                                                    **kwargs)
        return samples, intermediates, x_all, e_t_cond_all, e_t_uncond_all, t
    ...
    def ddim_sampling(self, cond, shape,
        ...
        for i, step in enumerate(iterator):
            ...
            img, pred_x0, x, e_t_cond, e_t_uncond, t = outs
            x_all.append(x)
            e_t_cond_all.append(e_t_cond)
            e_t_uncond_all.append(e_t_uncond)
            t_all.append(t)
        ...
        return img, intermediates, x_all, e_t_cond_all, e_t_uncond_all, t_all
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        return x_prev, pred_x0, x, e_t_cond, e_t_uncond, t

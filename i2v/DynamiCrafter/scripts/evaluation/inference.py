...
def image_guided_synthesis(model, prompts, videos, noise_shape, n_samples=1, ddim_steps=50, ddim_eta=1., \
    ...
    if unconditional_guidance_scale != 1.0:
        if model.uncond_type == "empty_seq":
            prompts = batch_size * [""]
            prompts = batch_size * ["flickering, inconsistent motion, frame mismatch, frame skipping, temporal artifacts, unstable movement, jittering, motion blur, repeated frames, lagging motion, frame warping, disjointed animation"]
            ...
            #uc_emb = torch.load('/group/ossdphi_algo_scratch_11/xiaominl/projects/ImageReward/train-sd2.1-base-null_emb-lr0.005-hpsv2-fp16-bz64/checkpoint-700/checkpoint.bin').to(model.device)
            #print(uc_emb.shape)

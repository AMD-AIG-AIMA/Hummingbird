...
def parse_args():
    ...
    parser.add_argument(
        "--negative_prompt",
        type=str,
        default="blurry, pixelated, noisy, glitches, watermarks, compression artifacts, overexposed, underexposed, color banding, unnatural colors, inconsistent lighting, incorrect white balance, low resolution, lack of detail, soft focus, bad hands, extra limbs, distorted facial features, incorrect proportions, missing body parts, misrendered objects, incorrect object sizes, deformed shapes, unrecognizable items, cluttered scenes, poor framing, unbalanced composition, elements cut off, inconsistent perspective, flattened depth, incorrect scaling, temporal flickering, stuttering motion, inconsistent frame rates, jerky transitions, inconsistent backgrounds, changing lighting between frames, disjointed scenes, ugly, unattractive visuals, clashing styles, inconsistent art style, unharmonious color schemes, abrupt cuts, poor transitions, repeated frames, illogical sequences, lack of continuity, incorrect setting, inappropriate elements for the theme, illegible text, misaligned text, unintended logos",

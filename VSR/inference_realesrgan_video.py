...
def inference_video(args, video_save_path, device=None, total_workers=1, worker_idx=0):
    ...
    if args.model_name == 'RealESRGAN_x4plus':  # x4 RRDBNet model
        model = RRDBNet(num_in_ch=3, num_out_ch=3, num_feat=args.num_feat, num_block=args.num_block, num_grow_ch=args.num_grow_ch, scale=4)
        netscale = 4
...
def main():
    ...
    parser.add_argument('--num_feat', type=int, default=32, help='num_feat of RRDB')
    parser.add_argument('--num_block', type=int, default=10, help='num_block of RRDB')
    parser.add_argument('--num_grow_ch', type=int, default=16, help='num_grow_ch of RRDB')
    ...
    parser.add_argument('--model_path', type=str, default='/group/ossdphi_algo_scratch_01/hecui102/AMDCodelib/Real-ESRGAN/weights/RealESRGAN_x4plus.pth', help='weight path')
    parser.add_argument(
        '--alpha_upsampler',
        type=str,
        default='realesrgan',
